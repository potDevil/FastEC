package example.fastec.hulk.com.pot_core.util.storage;
...
public class PotPreference {
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences(Pot.getApplicationContext());
